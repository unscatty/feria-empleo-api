 ...
 */
export const Allow = (...roles: RoleType[]): CustomDecorator<string> => SetMetadata('allow', roles);

/**
 *
 * @param  { RoleType[] } roles - Add list of roles to deny resource
 */
export const Deny = (...roles: RoleType[]): CustomDecorator<string> => SetMetadata('deny', roles);
