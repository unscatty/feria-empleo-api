...
export class companyAndContactTable1626284797544 implements MigrationInterface {
    name = 'companyAndContactTable1626284797544'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `contact_detail` ADD CONSTRAINT `FK_d005a3853116005286403c75ff2` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `company` ADD CONSTRAINT `FK_879141ebc259b4c0544b3f1ea4c` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
    }
